...
<div style="width: 80%; margin-left: 10%;margin-top: 5%">
    <div class="register-box-body">
        ...
        <form method="post" action="inserirPfPerfilConsumo.php" id="meuForm">

            <div class="form-group has-feedback">
                <label for="tb_perfil_consumo_cpf">CPF</label>
                <input type="text" class="form-control"   name="tb_perfil_consumo_cpf" placeholder="CPF "/>
...
$sql = "INSERT INTO `dataWebProducao`.`tb_perfil_consumo_pf`
(`idtb_perfil_consumo`,
`tb_perfil_consumo_cpf`,
`tb_perfil_consumo_descricao`)
VALUES
('',
'" . $_POST['tb_perfil_consumo_cpf'] . "',
...
if ($_POST['tb_perfil_consumo_cpf'] != null) {
