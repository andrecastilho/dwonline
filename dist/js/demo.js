...
//$("#cnpj").mask("99.999.999/9999-99");
    ...
    $(document).delegate('#btnInsertUser', 'click', function () {
        if ($('input#senha').val() === $('input#senha2').val()) {
        }
        $.get("http://54.94.199.133/layout1/pages/php/inserNewUser.php",
                {
                    cnpj: $('input#cnpj').val()
        ...
        //alert($("#checkativo").is(':checked'));

//        $.ajax({
//            url: "http://54.94.199.133/layout1/pages/php/inserNewUser.php",
//            data: {cnpj: $('input#cnpj').val()}
//        })
