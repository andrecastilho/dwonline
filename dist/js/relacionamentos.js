...
//Ajustar
    ...
    $.getJSON("../pages/php/buscaEndereco.php?endereco=" + endereco + "&numero=" + numero + "&bairro=" + bairro + "&cidade=" + cidade + "&cep=" + cep + "&loginEmpresa=" + $('#loginEmpresa').val() + "&cnpjEmpresa=" + $('#cnpjEmpresa').val() + "&uf=" + uf,
...
//telefones
    ...
    $.getJSON("../pages/php/buscaTelefone.php?telefone=" + telefone + "&ddd=" + ddd + "&loginEmpresa=" + $('#loginEmpresa').val() + "&cnpjEmpresa=" + $('#cnpjEmpresa').val(),
            function (data, status) {
