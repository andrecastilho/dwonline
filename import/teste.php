...
//verifica creditos
        ...
        echo"debitaDw-->" . $this->controleCustos->debitaMultiplosDw($empresaCnpj, 'enriquecimento', $totalCpfEnriquecidoGeral, $idEmriquecimeto) . "\n \n";
        //die(".");
...
//ok testado
        ...
        $pastaUpload = "/var/www/html/desenv/$empresaCnpj/";

// Pasta onde o arquivo vai ser salvo
        if (file_exists($pastaUpload)) {

            echo "\n\n--> Não criou pasta " . $pastaUpload . "\n\n";
        } else {
...
//die(".");
            ...
            $resultado = shell_exec("/var/www/html/exec/exec.sh '$nomeTabela' '/var/www/html/desenv/$empresaCnpj/$nomeArquivoCpf'");
// echo (">>>----> " . $resultado);
        } else {
            $resultado = shell_exec("/var/www/html/exec/exec.sh '$nomeTabela' '/var/www/html/desenv/$empresaCnpj/$nomeArquivoCnpj'");
//die(">>>---- " . $resultado);
        }
    ...
    public function utilizacaoSistemaTabelaContagem($server, $user, $totalCpfEnriquecidoGeral, $idEmriquecimeto) {
        ...
        $sqlInsert = "INSERT INTO tb_utilizacao_contagem
                            ...
                            values(" . str_pad($user['cnpjEmpresa'], 14, '0', STR_PAD_LEFT) . " ,'" . $user['filtro'] . "'," . $user['tb_utilizacao_sistema_idtb_user'] . "," . time() . ",$totalCpfEnriquecidoGeral,$idEmriquecimeto)";
