...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div style="text-align: center; padding-bottom: 2%; "><h4> Quantitativa  X  User</h4> </div>
                ...
                <div class="box-body table-responsive" id='ptable'>
                    ...
                    <table  id="tableExport" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $data_inicial = strtotime('-1 days', strtotime($ap->converte_data($_GET['dataInicial'])));
                            $data_final = strtotime('+1 days', strtotime($ap->converte_data($_GET['dataFinal'])));
                            $usuario = $_GET['usuarios'];
                            $empresa = $_GET['empresas'];

                            $ap->relatorioUtilizacaoSistemaQuantitativoPorUser($data_inicial, $data_final, $usuario, $empresa);
                            $ap->fechaConexao();
                            ?>
                        </tbody>
                    </table>
