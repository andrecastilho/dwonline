...
<html>
    <head>
        <title>Quantitativa  WebService</title>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div style="text-align: center; padding-bottom: 2%; "><h4> Quantitativa  WebService</h4> </div>
                    ...
                    <table  id="tableExport" class="table table-striped">
                        <thead>
                            <tr>
                                <th>Id Empresa</th>
                                <th>Nome Empresa</th>
                                <th>Qtd.Utilizada WebService</th>
                                <th>Valor Total WebService</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- php -->
                            ...
                            $ap->relatorioUtilizacaoSistemaQuantitativoWebService($data_inicial, $data_final, $usuario, $empresa);
                            $ap->fechaConexao();
                            ?>
                        </tbody>
                    </table>
