...
<html>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div style="text-align: center; padding-bottom: 2%; "><h4> Detalhado  CNF</h4> </div>
                ...
                <div class="box-body table-responsive" id='ptable'>
                    ...
                    <table  id="tableExport" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $ap->relatorioUtilizacaoSistemaDetalhadoCnf($data_inicial, $data_final, $usuario, $empresa);
                            $ap->fechaConexao();
                            ?>
                        </tbody>
                    </table>
