...
<html>
    <head>
        <title>Busca Detalhada Webservice</title>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div style="text-align: center; padding-bottom: 2%; "><h4> Busca Detalhada Webservice</h4> </div>
            <form  action="" method="GET" >
                <div id="box-toggle">
                    <div class="tgl">
                        Data Inicial &nbsp; <input type="datetime" id="dataInicial" name="dataInicial" value="">
                        Data Final  &nbsp; <input type="datetime" id="dataFinal" name="dataFinal" value="">
                        &nbsp;&nbsp;&nbsp;<input  type="submit"  style="vertical-align: text-bottom;" value="Buscar" /><br>


                        <div id="selector_destino">
                            &nbsp;Empresas: 
                            <select name="empresas" id="empresas" autofocus="autofocus" autocorrect="off" autocomplete="on">
                ...
                <div class="box-body table-responsive" id='ptable'>
                    ...
                    <table  id="tableExport" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            if ($data_inicial)
                                $ap->relatorioUtilizacaoSistemaDetalhadoWebService($data_inicial, $data_final, $usuario, $empresa);
                            $ap->fechaConexao();
                            ?>
                        </tbody>
                    </table>
