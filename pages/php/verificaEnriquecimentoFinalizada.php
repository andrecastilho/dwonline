...
$sql = "SELECT * FROM dataWebProducao.tb_enriquecimento
where tb_enriquecimento_msg_visualizada is null
AND tb_enriquecimento_empresa_envio = " . $db->anti_injection($_GET['empresaEnvio']);
...
if ($fetch) {
    ...
    $idtbEnriquecimento = $fetch[0]['idtb_enriquecimento'];
    $sqlEnrioEmail = "select * from tb_enriquecimento
where idtb_enriquecimento =" . $idtbEnriquecimento;
...
//print_r($fetchEmailEnviado);
    ...
    if ($fetchEmailEnviado) {

        if ($fetchEmailEnviado[0]['tb_enriquecimento_envio_email_finalizado'] == null) {
...
<html xmlns='http://www.w3.org/1999/xhtml'>
    ...
    <body>
        <table width='98%' border='0' align='center' cellpadding='0' cellspacing='0'>
            ...
            <tr>
                <td>Seu arquivo de enriquecimento foi processado com sucesso  <br>
                Logue no sistema, na sessão 'Enriquecimento' o arquivo está pronto para ser baixado</td>
            </tr>
            ...
            <tr>
             ...
             <tr>
                <td><span class='pedido'>Id Processo : </span><span class='pedido_numero'>" . $fetchEmailEnviado[0]['idtb_enriquecimento'] . "</span></td>
            </tr>
            ...
            <tr>
              ...
              <tr>
                <td><span class='pedido'>Descrição : </span><span class='pedido_numero'>" . $fetchEmailEnviado[0]['tb_enriquecimento_descricao'] . "</span></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
        ...
        <table width='98%' border='0' align='center' cellpadding='0'>
            ...
            $emailSentId = $client->sendEmail(array(
                ...
                'Message' => array(
                    ...
                    'Subject' => array(
                        // Data is required
                        'Data' => 'Enriquecimento - Finalizado Processamento de arquivo',
                        'Charset' => 'UTF-8',
                    ),
                    // Body is required
                    'Body' => array(
            ...
            $query = $db->update('tb_enriquecimento', 'idtb_enriquecimento', $idtbEnriquecimento, array(
                'tb_enriquecimento_envio_email_finalizado' => '1'));
        }
    }
}
