...
$sql = "SELECT * FROM  tb_extracao 
WHERE tb_extracao_msg_visualizada IS NULL  
 and tb_extracao_arquivo_cpf is not null
 and tb_extracao_arquivo_cnpj is not null
 and tb_extracao_processar_contada IS NOT NULL
...
if ($fetch) {
        ...
        $sqlEnrioEmail = "select tb_extracao_envio_email_finalizado from tb_extracao
...
// Obtém os dados da base de dados MySQL
        ...
        if ($fetchEmailEnviado[0]['tb_extracao_envio_email_finalizado'] == null) {
...
<html xmlns='http://www.w3.org/1999/xhtml'>
    ...
    <body>
        <table width='98%' border='0' align='center' cellpadding='0' cellspacing='0'>
            ...
            <tr>
                <td>Seu arquivo de extração foi processado com sucesso e esta pronto para ser baixado. <br>
                Logue no sistema e baixe seu arquivo atravez do menu 'Extração'</td>
            </tr>
  ...
  <tr>
                <td><span class='pedido'>Id : </span><span class='pedido_numero'>" . $idtbExtração . "</span></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
        ...
        <table width='98%' border='0' align='center' cellpadding='0'>
            ...
            $emailSentId = $client->sendEmail(array(
                ...
                'ReplyToAddresses' => array('andxuxa@gmail.com'),
                'ReturnPath' => 'dwonline@dwonline.com.br'
            ));

            $queryAtualiza = $db->update('tb_extracao', 'idtb_extracao', $idtbExtração, array(
                'tb_extracao_envio_email_finalizado' => '1'));
            
            //print_r($queryAtualiza);
            //die(".");
        }
    }
